...
};run.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:$$$cl6.Anything},$ps:[],pkg:'ceylon.example.basic.titanium',d:$$METAMODEL$$['ceylon.example.basic.titanium']['run']};//run.$$targs$$={Arguments:{t:$$$cl6.Empty},Return:{t:$$$cl6.Anything}};
...
Global$application.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:$$$cl6.Basic},satisfies:[],pkg:'ceylon.example.basic.titanium.application',d:$$METAMODEL$$['ceylon.example.basic.titanium.application']['Global']};
function $init$Global$application(){
    if (Global$application.$$===undefined){
        $$$cl6.initTypeProto(Global$application,'ceylon.example.basic.titanium.application::Global',$$$cl6.Basic);
        (function($$global){
...
Device$application.$$metamodel$$={mod:$$METAMODEL$$,'super':{t:$$$cl6.Basic},satisfies:[],pkg:'ceylon.example.basic.titanium.application',d:$$METAMODEL$$['ceylon.example.basic.titanium.application']['Device']};
function $init$Device$application(){
    if (Device$application.$$===undefined){
        $$$cl6.initTypeProto(Device$application,'ceylon.example.basic.titanium.application::Device',$$$cl6.Basic);
        (function($$device){
            ...
            $$device.isTablet.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:$$$cl6.Boolean},$ps:[],$an:function(){return[$$$cl6.shared()];},pkg:'ceylon.example.basic.titanium.application',d:$$METAMODEL$$['ceylon.example.basic.titanium.application']['Device']['$m']['isTablet']};
            ...
            $$device.isDroid.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:$$$cl6.Boolean},$ps:[],$an:function(){return[$$$cl6.shared()];},pkg:'ceylon.example.basic.titanium.application',d:$$METAMODEL$$['ceylon.example.basic.titanium.application']['Device']['$m']['isDroid']};
            ...
            $$device.isIOS.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:$$$cl6.Boolean},$ps:[],$an:function(){return[$$$cl6.shared()];},pkg:'ceylon.example.basic.titanium.application',d:$$METAMODEL$$['ceylon.example.basic.titanium.application']['Device']['$m']['isIOS']};
            ...
            };$$device.load.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:$$$cl6.Anything},$ps:[],$an:function(){return[$$$cl6.shared()];},pkg:'ceylon.example.basic.titanium.application',d:$$METAMODEL$$['ceylon.example.basic.titanium.application']['Device']['$m']['load']};
