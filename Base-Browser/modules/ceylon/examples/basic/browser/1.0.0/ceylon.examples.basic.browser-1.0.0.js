...
exports.init=init;
init.$$metamodel$$={mod:$$METAMODEL$$,$t:{t:$$$cl6.Anything},$ps:[],$an:function(){return[$$$cl6.shared()];},pkg:'ceylon.examples.basic.browser',d:$$METAMODEL$$['ceylon.examples.basic.browser']['init']};//init.$$targs$$={Arguments:{t:$$$cl6.Empty},Return:{t:$$$cl6.Anything}};
});
