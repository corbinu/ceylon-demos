...
function init(){
    /*Begin dynamic block*/
    (typeof jQuery==='undefined'||jQuery===null?$$$cl1.throwexc('Undefined or null reference: jQuery'):jQuery)($$$cl1.String(".main",5).valueOf()).text($$$cl1.String("Text changed by ceylon",22).valueOf());
    /*End dynamic block*/
}
exports.init=init;
